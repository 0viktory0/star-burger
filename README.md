...
Пример развернутого сайта тут: [star-burger.ru](http://star-burger.ru/)
...
- `YANDEX_API_KEY` - ключ от API Яндекс-геокодера ([инструкция тут](https://dvmn.org/encyclopedia/api-docs/yandex-geocoder-api/)).
